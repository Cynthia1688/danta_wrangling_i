...
```{r}
litters_df = select(litters_df, group, litter_number, gd0_weight)
...
select(litters_df, group, litters_id = litter_number)
...
```{r}
filter(litters_df, grouo == "Con7")

filter(litters_df, grouo == "Mod8")
